...
| forge-release-candidate-handoff | Ready | Yes | `forge release-candidate validate --candidate examples/release-preview/release-candidate.v0.1.example.json`, ao-forge main CI run 28040935640, ao-forge Release Preview run 28056174867, ao-forge Production Readiness Ops run 28056174653 |
