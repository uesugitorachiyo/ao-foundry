...
| AO Forge | Ready | license policy, license policy required in branch protection, GoalRun fixtures, `go test ./...`, `go vet ./...`, `go build`, production-readiness schemas, actionlint, Release Preview run 28031669750, Production Readiness Ops run 28037052612, PR #131 merged, main CI run `28036941430` |
...
| forge-release-candidate-handoff | Ready | Yes | `forge release-candidate validate --candidate examples/release-preview/release-candidate.v0.1.example.json`, ao-forge main CI run 28036941430, ao-forge Release Preview run 28031669750, ao-forge Production Readiness Ops run 28037052612 |
