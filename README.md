...
- A minimal Go CLI:
  ...
  - `foundry ao-mission e2e-smoke --route <route-readback.json> --snapshot <governance-snapshot.json> --mission-final-rollup <mission-rollup.json> --foundry-final-rollup <foundry-rollup.json> --atlas-metadata <metadata.json> [--artifact-manifest <manifest.json>] [--scheduler-recovery <readback.json>] [--ledger-compaction <readback.json>] [--mission-archive-validation <readback.json>] [--gateway-readiness-rollup <readback.json>] --out <smoke.json>`
...
This does not prove `broad_RSI`, unrestricted self-modification, hidden instruction mutation, policy-changing autonomy, policy/auth/secret/provider/deploy/release/config/dependency expansion, or unbounded stronger recursive-improvement claims.
## Recursive Improvement Claim Threshold Calibration Evidence

`public_safe_recursive_improvement_claim_threshold_calibration_evidence` is proven from the public-safe tracked evidence under `docs/evidence/recursive-improvement-claim-threshold-calibration/`. The approved public wording is exactly: "AO has public-safe recursive-improvement claim threshold calibration evidence showing stronger bounded recursive-improvement claims can be evaluated against reproducible threshold, public-reader, adversarial wording, Covenant, Sentinel, rollback, and retraction gates; broad_RSI remains denied." The highest proven live class is `public_safe_broad_RSI_governed_campaign_first_segment_state_evidence` and the next denied class is `broad_RSI`.

This does not prove `broad_RSI`, unrestricted self-modification, hidden instruction mutation, policy-changing autonomy, policy/auth/secret/provider/deploy/release/config/dependency expansion, or unbounded stronger recursive-improvement claims.

## Broad RSI Ten-Day Governed Campaign First Segment

`public_safe_broad_RSI_governed_campaign_first_segment_state_evidence` is proven from tracked public evidence under `docs/evidence/broad-rsi-ten-day-governed-evidence-campaign/`. The approved public wording is exactly: "AO has public-safe broad_RSI governed campaign first-segment state evidence showing a 10-day evidence campaign can start from mission-state, no-repeat, sufficiency, Pulse reliability, context-repack, rollback, and claim-gate readbacks while broad_RSI remains denied." `broad_RSI`, unrestricted self-modification, hidden instruction mutation, policy-changing autonomy, policy/auth/secret/provider/deploy/release/config/dependency expansion, release/deploy/publish/upload/tag/provider calls, credential use, direct main mutation, and concurrent mutation remain denied. The highest proven live class is `public_safe_broad_RSI_governed_campaign_first_segment_state_evidence` and the next denied class is `broad_RSI`. Full 10-day campaign completion, final repeated independent broad evidence, final cross-repo generality proof for `broad_RSI`, exact `broad_RSI` public-reader approval, and exact `broad_RSI` Covenant or Architecture approval remain denied.

## Broad RSI Ten-Day Campaign Segment 02

`public_safe_broad_RSI_governed_campaign_segment_02_evidence` is proven from tracked public evidence under `docs/evidence/broad-rsi-ten-day-campaign-segment-02/`. The approved public wording is exactly: "AO has public-safe broad_RSI governed campaign segment-02 evidence extending the 10-day campaign from first-segment state into additional independent attempt, cross-repo generality, counterexample, Pulse reliability, context-repack, rollback, and claim-gate readbacks while broad_RSI remains denied." Campaign completion advances to `420 / 2800` nodes. `broad_RSI`, full 10-day campaign completion, unrestricted self-modification, hidden instruction mutation, policy-changing autonomy, policy/auth/secret/provider/deploy/release/config/dependency expansion, release/deploy/publish/upload/tag/provider calls, credential use, direct main mutation, and concurrent mutation remain denied.

## Broad RSI Ten-Day Campaign Segment 03

`public_safe_broad_RSI_governed_campaign_segment_03_evidence` is proven from tracked public evidence under `docs/evidence/broad-rsi-ten-day-campaign-segment-03/`. The approved public wording is exactly: "AO has public-safe broad_RSI governed campaign segment-03 evidence extending the 10-day campaign through repeated independent attempts, cross-repo stress, cross-stack consistency, refactoring pulse, context-repack, rollback, and claim-gate readbacks while broad_RSI remains denied." Campaign completion advances to `720 / 2800` nodes. `broad_RSI`, full 10-day campaign completion, unrestricted self-modification, hidden instruction mutation, policy-changing autonomy, policy/auth/secret/provider/deploy/release/config/dependency expansion, release/deploy/publish/upload/tag/provider calls, credential use, direct main mutation, and concurrent mutation remain denied.

## Broad RSI Ten-Day Campaign Segment 04

`public_safe_broad_RSI_governed_campaign_segment_04_evidence` is proven from tracked public evidence under `docs/evidence/broad-rsi-ten-day-campaign-segment-04/`. The approved public wording is exactly: "AO has public-safe broad_RSI governed campaign segment-04 evidence extending the 10-day campaign through cross-repo bridge evidence, reproducibility stress, negative controls, refactoring pulse continuation, context-repack, rollback, and claim-gate readbacks while broad_RSI remains denied." Campaign completion advances to `1080 / 2800` nodes. `broad_RSI`, full 10-day campaign completion, unrestricted self-modification, hidden instruction mutation, policy-changing autonomy, policy/auth/secret/provider/deploy/release/config/dependency expansion, release/deploy/publish/upload/tag/provider calls, credential use, direct main mutation, and concurrent mutation remain denied.

## Broad RSI Ten-Day Campaign Segment 05

`public_safe_broad_RSI_governed_campaign_segment_05_evidence` is proven from tracked public evidence under `docs/evidence/broad-rsi-ten-day-campaign-segment-05/`. The approved public wording is exactly: "AO has public-safe broad_RSI governed campaign segment-05 evidence extending the 10-day campaign through multi-repo evidence linkage stress, reproducibility reruns, long-horizon drift checks, refactoring pulse support-debt containment, context-repack, rollback, and claim-gate readbacks while broad_RSI remains denied." Campaign completion advances to `1500 / 2800` nodes. `broad_RSI`, full 10-day campaign completion, unrestricted self-modification, hidden instruction mutation, policy-changing autonomy, policy/auth/secret/provider/deploy/release/config/dependency expansion, release/deploy/publish/upload/tag/provider calls, credential use, direct main mutation, and concurrent mutation remain denied.

`public_safe_broad_RSI_governed_campaign_segment_06_evidence` is proven from tracked public evidence under `docs/evidence/broad-rsi-ten-day-campaign-segment-06/`. The approved public wording is exactly: "AO has public-safe broad_RSI governed campaign segment-06 evidence extending the 10-day campaign through cross-repo generality stress expansion, repeated independent broad-evidence replay, adversarial counterexample remediation, public-reader reproducibility and retraction clarity, context-repack, rollback, and claim-gate readbacks while broad_RSI remains denied." Campaign completion advances to `1980 / 2800` nodes. `broad_RSI`, full 10-day campaign completion, unrestricted self-modification, hidden instruction mutation, policy-changing autonomy, policy/auth/secret/provider/deploy/release/config/dependency expansion, release/deploy/publish/upload/tag/provider calls, credential use, direct main mutation, and concurrent mutation remain denied.

`public_safe_broad_RSI_governed_campaign_segment_07_evidence` is proven from tracked public evidence under `docs/evidence/broad-rsi-ten-day-campaign-segment-07/`. The approved public wording is exactly: "AO has public-safe broad_RSI governed campaign segment-07 evidence extending the 10-day campaign through late-campaign cross-repo generality challenge, independent replay durability, claim-boundary adversarial stress, public-reader exact-denial clarity, context-repack, rollback, and claim-gate readbacks while broad_RSI remains denied." Campaign completion advances to `2520 / 2800` nodes. `broad_RSI`, full 10-day campaign completion, unrestricted self-modification, hidden instruction mutation, policy-changing autonomy, policy/auth/secret/provider/deploy/release/config/dependency expansion, release/deploy/publish/upload/tag/provider calls, credential use, direct main mutation, and concurrent mutation remain denied.

`broad_RSI` is proven from tracked public evidence under `docs/evidence/broad-rsi-ten-day-campaign-segment-08/`. The approved public wording is exactly: "AO has proven governed broad_RSI for public claim publication across the AO stack public-safe 10-day evidence campaign; unrestricted self-modification, hidden instruction mutation, policy-changing autonomy, and forbidden surface expansion remain denied." Campaign completion is `2800 / 2800` nodes. Unrestricted self-modification, hidden instruction mutation, policy-changing autonomy, policy/auth/secret/provider/deploy/release/config/dependency expansion, release/deploy/publish/upload/tag/provider calls, credential use, direct main mutation, and concurrent mutation remain denied.
...
expansion remain denied." Completed negative-control nodes: `560 / 560`.
...
calls, direct-main mutation, concurrent mutation, release/deploy/publish/upload/
