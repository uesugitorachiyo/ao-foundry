...
| AO Forge | Ready | license policy, license policy required in branch protection, GoalRun fixtures, `go test ./...`, `go vet ./...`, `go build`, production-readiness schemas, actionlint, Release Preview run 28060735115, Production Readiness Ops run 28060835289, PR #134 merged, main CI run `28060735171` |
...
| AO Covenant | Ready | `covenant policy spine --json`, covenant.policy-spine-result.v1, Release Readiness run 28061623129, branch protection verifier, Production Readiness Ops run 28061624617, PR #52 merged, main CI run `28061483204` |
...
| forge-release-candidate-handoff | Ready | Yes | `forge release-candidate validate --candidate examples/release-preview/release-candidate.v0.1.example.json`, ao-forge main CI run 28060735171, ao-forge Release Preview run 28060735115, ao-forge Production Readiness Ops run 28060835289 |
| covenant-policy-spine | Ready | Yes | `covenant policy spine --json`, covenant.policy-spine-result.v1, ao-covenant main CI run 28061483204, ao-covenant Release Readiness run 28061623129, ao-covenant Production Readiness Ops run 28061624617 |
