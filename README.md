...
| AO Covenant | Ready | `covenant policy spine --json`, covenant.policy-spine-result.v1, Release Readiness run 28055013267, branch protection verifier, Production Readiness Ops run 28055014809, PR #51 merged, main CI run `28048024016` |
...
| covenant-policy-spine | Ready | Yes | `covenant policy spine --json`, covenant.policy-spine-result.v1, ao-covenant main CI run 28048024016, ao-covenant Release Readiness run 28055013267, ao-covenant Production Readiness Ops run 28055014809 |
