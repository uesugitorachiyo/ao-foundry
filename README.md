...
| AO Covenant | Ready | `covenant policy spine --json`, covenant.policy-spine-result.v1, Release Readiness run 28048266398, branch protection verifier, Production Readiness Ops run 28048382580, PR #51 merged, main CI run `28048024016` |
...
| forge-release-candidate-handoff | Ready | Yes | `forge release-candidate validate --candidate examples/release-preview/release-candidate.v0.1.example.json`, ao-forge main CI run 28040935640, ao-forge Release Preview run 28040935458, ao-forge Production Readiness Ops run 28042017044 |
| covenant-policy-spine | Ready | Yes | `covenant policy spine --json`, covenant.policy-spine-result.v1, ao-covenant main CI run 28048024016, ao-covenant Release Readiness run 28048266398, ao-covenant Production Readiness Ops run 28048382580 |
