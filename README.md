...
| forge-release-candidate-handoff | Ready | Yes | `forge release-candidate validate --candidate examples/release-preview/release-candidate.v0.1.example.json`, ao-forge main CI run 28017583706, ao-forge Release Preview run 28011603944, ao-forge Production Readiness Ops run 28027282325 |
