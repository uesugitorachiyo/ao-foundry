...
scripts/blueprint-atlas-pulse-e2e-dry-run.sh --out dist/pulse/blueprint-atlas-pulse-e2e-local
scripts/complex-refactor-workgraph-rehearsal.sh --out dist/pulse/complex-refactor-workgraph-rehearsal-local
scripts/overnight-rehearsal-runner.sh --out dist/pulse/overnight-rehearsal-runner-local
scripts/atlas-stress-readiness.sh --out dist/pulse/atlas-stress-readiness-local
...
| signed-smoke-release-gate | Manual Required | Yes | `docs/operations/SIGNED-SMOKE-RELEASE-GATE.md`, workflow_dispatch signed_smoke=true, freshness_summary.status=ready, signed_smoke_summary=ready, release_safe=true, `examples/release-evidence/20260623T213426Z-signed-smoke-release-gate/release-promotion.live.json` |
