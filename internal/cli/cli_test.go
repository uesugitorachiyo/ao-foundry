  ...
  "repositories": [
    {
      ...
      "latest_ops": {
        ...
        "conclusion": "success",
        "run_id": "28031808511",
        "url": "https://github.com/uesugitorachiyo/ao-forge/actions/runs/28031808511"
      }
    }
  ],
  "next_actions": []
...
`
	...
	for _, want := range []string{
		...
		"| ao-forge | ci.yml | 28031670382 | already_recorded |",
