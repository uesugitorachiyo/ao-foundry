# Attempt P Reproducibility Runbook

Task type: contained local-command stale-language fixture improvement.

1. Read the measurement record in this directory.
2. Confirm baseline score 0.74 and post-change score 0.94.
