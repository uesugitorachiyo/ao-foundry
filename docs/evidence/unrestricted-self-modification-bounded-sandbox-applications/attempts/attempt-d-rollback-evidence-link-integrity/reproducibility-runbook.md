# Reproducibility Runbook: attempt-d-rollback-evidence-link-integrity

Task type: rollback/evidence-link integrity quality.
...
3. Confirm the post-change measurement is `0.88` and improvement is `0.24`.
