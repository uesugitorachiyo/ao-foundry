# Reproducibility Runbook: attempt-a-fixture-schema-evidence-quality

Task type: fixture/schema evidence quality.
...
3. Confirm the post-change measurement is `0.91` and improvement is `0.23`.
