...
15. Before promotion, run the signed-smoke workflow with
    `workflow_dispatch signed_smoke=true` and require `release_safe=true`.
16. Confirm no release step requires credentials, remote services, sibling
